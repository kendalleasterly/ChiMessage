...
////
////
////        nsView.blendingMode = NSVisualEffectView.BlendingMode.behindWindow
////        nsView.material = NSVisualEffectView.Material.fullScreenUI
////
...
//    let background = Color(NSColor(red: 60 / 255, green: 60 / 255, blue: 67 / 255, alpha: 0.1))
